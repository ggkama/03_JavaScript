...
btn1.addEventListener("click", () => {
    ...
    console.log("수정된 age : ", person);


    // 2) 삭제 - 객체내에서 key가 일치하는 요소(K:V)를 삭제
    // delete 객체명.key
    // delete 객체명.["key"]
...
btn2.addEventListener("click", ()=>{
    ...
    const student = {}; // 빈 객체 생성 
        ...
        // 객체에 존재하는 함수 === 매서드(method)
        // 매서드 작성시 화살표 함수 X (this관련 문제발생)
...
/* 
    ...
    btn.addEventListener("click", finction(){
        console.log(this);
    });
...
const addStundet = document.querySelector("#addStudent");

addStundet.addEventListener("click", ()=>{
...
checkJson.addEventListener("click",()=>{
    ...
    // JSON.stringify(JS) : JS객체가 -> JSON(문자열) 변경
    ...
    console.log("JSON.parse : ", JSON.parse(menu), typeof menu);
