...
function constCheck(){
    ...
    /* 상수(값 변경x) */
    nationalCode = 1; // Assignment to constant variable. -> 상수에 값을 대입 (오류)
    console.log("nationalCode : ", nationalCode);
...
{ // 함수 정의 시작
    ...
    console.log("num2",num2); // var를 이용해서 num2 변수를 선언
    // var는 함수 레벨 범위
...
{ // 함수가 정의 시작
    ...
    console.log("if 실행 전 fn2") // 함수 지역 변수2
...
function typeCheck(){
    ...
    console.log("height : ", height, typeof age);
    console.log("sight : ", sight, typeof age);
    ...
    console.log("bool1 : ", bool2, typeof bool2);

    /* object(객체) : 값을 여려개 저장할 수 있는 형태 */
    ...
    console.log( sumFn(-1311, 123));
    console.log( sumFn(11, 3217));
