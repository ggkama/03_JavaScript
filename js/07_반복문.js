...
function check1() {
    ...
    for (let num = 1; num <= 5; num++) {
        ...
        // [조건식] 
        // -> num 변수에 저장된 값이 5 이하면 true -> 반복 O
        //      -> 반복 O == for문 {} 내부 코드를 수행
...
/** 입력 받은 범위 내 지정된 수의 배수를 출력(한줄), 합계 구하기 
 * 시작 : 5
 * 종료 : 20
 * 배수 : 3
 * 
