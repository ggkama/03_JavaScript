...
function check1(){
    ...
    console.log("num1 == num3 :",num1 == num3); // flase
...
function oddEvenCheck(){
    ...
    // 홀수 == 2의 배수 -1 또는 +1 == 2로 나눴을 때 나머지가 0인 수
